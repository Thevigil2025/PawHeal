                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: const Color(0xFFE5B50A)),
                    ),
                  ),
                ],
              ),
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Recommended Treatment', style: Theme.of(context).textTheme.titleLarge),
            const SizedBox(height: 16),
            _buildTreatmentItem(
              context,
            ...
            _buildTreatmentItem(
              ...
              description: 'Apply a thin layer to the affected area 3 times daily',
            ),
          ],
        ),
      ),
