...
class PetServicesScreen extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildServiceCard(context, 'Pawsome Veterinary Clinic', '123 Main Street, Anytown',
              'https://placehold.co/600x400/EFEFEF/333333?text=Veterinary+Clinic'),
          const SizedBox(height: 16),
          _buildServiceCard(context, 'Happy Paws Pet Shop', '456 Oak Avenue, Anytown',
              'https://placehold.co/600x400/EFEFEF/333333?text=Pet+Shop'),
          const SizedBox(height: 16),
          _buildServiceCard(context, 'Animals First NGO', '789 Pine Lane, Anytown',
  ...
  Widget _buildCategoryButton(BuildContext context, String text, {bool isSelected = false}) {
    return Container(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: isSelected ? BorderSide.none : BorderSide(color: Colors.grey.shade300, width: 1),
          ),
          elevation: 0,
  ...
  Widget _buildServiceCard(BuildContext context, String title, String address, String imageUrl) {
    return Card(
      elevation: 4,
